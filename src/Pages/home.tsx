...
const Home: React.FC<HomeProps> = (props) => {
  ...
  return (
    <div>
      <Title />
      <button
        className="z-20 absolute top-4 right-8 bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded"
        type="button"
