...
export const AddTreeForm: React.FC<AddTreeFormProps> = (props) => {
  ...
  const handleImageUpload = async () => {
    ...
    const imageRef = storage.ref(
      props.userID + `/favTrees/favTree${props.nextTreeNum}`
    );
  ...
  if (props.isFormShown) {
    // if form is toggled on, render either error msg or addTreeForm depending on isTreeLimitReached
    if (props.isTreeLimitReached) {
      return <ErrorMsg onToggleError={props.onToggleForm} />;
    } else {
      return (
        <>
